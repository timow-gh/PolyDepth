                           ...
                           PQP_REAL rkInertia[3][3])
{
  ...
  PQP_REAL afIntegral[10] = {(PQP_REAL)0.0,
                             (PQP_REAL)0.0,
                             (PQP_REAL)0.0,
                             (PQP_REAL)0.0,
                             (PQP_REAL)0.0,
  ...
  // center of mass
  rkCenter = Coord3D(afIntegral[1], afIntegral[2], afIntegral[3]) / rfMass;
  ...
  if (bBodyCoords)
  {
    rkInertia[0][0] -= rfMass * (rkCenter.Y() * rkCenter.Y() + rkCenter.Z() * rkCenter.Z());
    rkInertia[0][1] += rfMass * rkCenter.X() * rkCenter.Y();
    rkInertia[0][2] += rfMass * rkCenter.Z() * rkCenter.X();
    rkInertia[1][0] = rkInertia[0][1];
    rkInertia[1][1] -= rfMass * (rkCenter.Z() * rkCenter.Z() + rkCenter.X() * rkCenter.X());
    rkInertia[1][2] += rfMass * rkCenter.Y() * rkCenter.Z();
    rkInertia[2][0] = rkInertia[0][2];
    rkInertia[2][1] = rkInertia[1][2];
    rkInertia[2][2] -= rfMass * (rkCenter.X() * rkCenter.X() + rkCenter.Y() * rkCenter.Y());
  }
}
