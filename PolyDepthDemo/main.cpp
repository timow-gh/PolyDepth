...
// good
static const char* modelFile1 = "bunny_noholes.tri";
static const char* modelFile2 = "bunny_noholes.tri";

static const char* aniPath2 = "bunny40k_1.ani";
static const char* aniPath1 = "bunny40k_2.ani";
...
inline void glVertex3v(float V[3])
{
  glVertex3fv(V);
}
inline void glVertex3v(double V[3])
{
  glVertex3dv(V);
}
...
void cb_display() // Display
{
  ...
  tframes[iframe] = duration.count() / nTests;
...
void readXFormFrames(const char* filename1, const char* filename2)
{
  ...
  while (fin1.good())
  {
    ...
    fin1 >> xform->R[0][0] >> xform->R[1][0] >> xform->R[2][0] >> xform->R[0][1] >> xform->R[1][1] >> xform->R[2][1] >> xform->R[0][2] >>
        xform->R[1][2] >> xform->R[2][2];
  ...
  while (fin2.good())
  {
    ...
    fin2 >> xform->R[0][0] >> xform->R[1][0] >> xform->R[2][0] >> xform->R[0][1] >> xform->R[1][1] >> xform->R[2][1] >> xform->R[0][2] >>
        xform->R[1][2] >> xform->R[2][2];
